...
// * @version 2018/11/28
// **/
//case class SQLAppSummaryV2 (@BeanProperty val appInfo: AppInfoSummary,
...
//
//case class AppInfoSummary(@BeanProperty id: String,
//                          @BeanProperty bizId: String,
//                          @BeanProperty duration: Int)
//
//case class JobSummary(@BeanProperty val jobId: Int,
...
//
//case class StageSummary (@BeanProperty val status: StageStatus,
