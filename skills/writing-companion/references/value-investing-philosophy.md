# Value Investing Philosophy for Life

## Core Concepts (Graham/Buffett)
...
### Mr. Market
**Investment**: Market is manic-depressive; don't let its daily quotes affect you
...
**Investment**: Underlying business value vs stock price
...
**Investment**: Only invest in what you understand
...
### Long-term Holding
**Investment**: Compounding works over decades
...
## Anti-Patterns (What Value Investing Rejects)

### Momentum Investing
- Chasing what's hot
- Life parallel: Career decisions based on current hype

### Day Trading
- Short-term thinking
- Life parallel: Optimizing for quarterly reviews

### Excessive Diversification
- Diworsification (Buffett)
- Life parallel: Trying to be good at everything

## Writing Angles

### 1. The DCF of Life Decisions
...
Both value investing and Miyazaki films share:
- **Patience**: Good things take time
- **Acceptance**: Of seasons, of cycles, of imperfection
- **Anti-hustle**: Quiet work over spectacle
- **Intrinsic worth**: Over market validation
...
- "It's not that we have more patience, we just have a lower time preference."
