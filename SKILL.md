...
This file defines the repository's personal knowledge-management workflow:
capture, organize, connect, review, and synthesize learning materials. It is not
the primary coding-agent rulebook; use `AGENTS.md` for implementation guidance.
It is not the project backlog; use `TASKS.md` for active work items.
