...
# 兼容自定义 Qwen API 配置（支持第三方 Qwen 服务或兼容接口）
# 优先从环境变量 QWEN_API_KEY 和 QWEN_BASE_URL 读取
QWEN_API_KEY = ""      # 自定义 Qwen API Key，若设置则优先使用
QWEN_BASE_URL = ""     # 自定义 Qwen API 基础 URL，例如 "https://api.example.com/v1"
# DASHSCOPE_API_KEY = "sk-8115d15866a04eecaa8f1577a90a4f4a" # 阿里灵积云API_KEY（用于接入qwen-max，dashscope-qwen3-14b，dashscope-deepseek-r1等）
...
# LLM_MODEL = "dashscope-qwen3-32b" # 可选 ↓↓↓
LLM_MODEL = "claude-3-sonnet-20240229" # 可选 ↓↓↓
# LLM_MODEL = "MiniMax-M2.1" # 可选 ↓↓↓
AVAIL_LLM_MODELS = ["qwen-max", "o1-mini", "o1-mini-2024-09-12", "o1", "o1-2024-12-17", "o1-preview", "o1-preview-2024-09-12",
                    ...
                    "MiniMax-M2.1", "claude-3-sonnet-20240229",
                    ]
