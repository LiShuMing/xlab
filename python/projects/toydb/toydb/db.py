"""
This module contains the main component of ToyDB: the database.
"""
...
# class to ToyDB. Currently, this supports PyCharm, Pyright/VS Code and MyPy.
TableBase: Type[Table] = with_typehint(Table)


class ToyDB(TableBase):
    """
    The main class of ToyDB.

    The ``ToyDB`` class is responsible for creating the storage class instance
    ...
    def __init__(self, *args, **kwargs) -> None:
        """
        Create a new instance of ToyDB.
        """
    ...
    def table(self, name: str, **kwargs) -> Table:
        ...
        created using the :attr:`~tinydb.database.ToyDB.table_class` class.
    ...
    def tables(self) -> Set[str]:
        ...
        # ToyDB stores data as a dict of tables like this:
        #
        #   {
        #       '_default': {
        #           0: {document...},
    ...
    def storage(self) -> Storage:
        """
        Get the storage instance used for this ToyDB instance.
    ...
    def close(self) -> None:
        ...
        To ensure this method is called, the ToyDB instance can be used as a
        context manager::
    ...
    def __enter__(self):
        ...
        :meth:`~tinydb.database.ToyDB.close` method is called upon leaving
        the context.
