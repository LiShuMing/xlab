...
0000000000001140 <main>:
    ...
    115a:	55                   	push   %rbp
    115b:	48 8d 0d 3e 36 00 00 	lea    0x363e(%rip),%rcx        # 47a0 <a>
    1162:	48 8d 15 17 33 00 00 	lea    0x3317(%rip),%rdx        # 4480 <b>
    ...
    13f0:	c5 fd 28 14 01       	vmovapd (%rcx,%rax,1),%ymm2
    13f5:	c5 ed 58 04 02       	vaddpd (%rdx,%rax,1),%ymm2,%ymm0
    ...
    140b:	48 8d 1d 4e 2d 00 00 	lea    0x2d4e(%rip),%rbx        # 4160 <c>
    1412:	4c 8d b3 20 03 00 00 	lea    0x320(%rbx),%r14
    1419:	4c 8d 25 20 2c 00 00 	lea    0x2c20(%rip),%r12        # 4040 <_ZSt4cout@GLIBCXX_3.4>
    1420:	4c 8d 2d dd 0b 00 00 	lea    0xbdd(%rip),%r13        # 2004 <_IO_stdin_used+0x4>
    1427:	c5 f8 77             	vzeroupper 
    142a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1430:	c5 fb 10 03          	vmovsd (%rbx),%xmm0
    1434:	4c 89 e7             	mov    %r12,%rdi
    1437:	e8 f4 fc ff ff       	call   1130 <_ZNSo9_M_insertIdEERSoT_@plt>
    143c:	48 89 c7             	mov    %rax,%rdi
    143f:	ba 01 00 00 00       	mov    $0x1,%edx
    1444:	4c 89 ee             	mov    %r13,%rsi
    1447:	48 83 c3 08          	add    $0x8,%rbx
    144b:	e8 a0 fc ff ff       	call   10f0 <_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l@plt>
    1450:	4c 39 f3             	cmp    %r14,%rbx
    1453:	75 db                	jne    1430 <main+0x2f0>
    1455:	48 8b 05 e4 2b 00 00 	mov    0x2be4(%rip),%rax        # 4040 <_ZSt4cout@GLIBCXX_3.4>
    145c:	48 8b 40 e8          	mov    -0x18(%rax),%rax
    1460:	49 8b 9c 04 f0 00 00 	mov    0xf0(%r12,%rax,1),%rbx
    1467:	00 
    1468:	48 85 db             	test   %rbx,%rbx
    146b:	74 4a                	je     14b7 <main+0x377>
    146d:	80 7b 38 00          	cmpb   $0x0,0x38(%rbx)
    1471:	74 29                	je     149c <main+0x35c>
    1473:	0f be 73 43          	movsbl 0x43(%rbx),%esi
    1477:	4c 89 e7             	mov    %r12,%rdi
    147a:	e8 41 fc ff ff       	call   10c0 <_ZNSo3putEc@plt>
    147f:	48 89 c7             	mov    %rax,%rdi
    1482:	e8 49 fc ff ff       	call   10d0 <_ZNSo5flushEv@plt>
    1487:	48 83 c4 08          	add    $0x8,%rsp
    148b:	5b                   	pop    %rbx
    148c:	41 5a                	pop    %r10
    148e:	41 5c                	pop    %r12
    1490:	41 5d                	pop    %r13
    ...
    149f:	e8 5c fc ff ff       	call   1100 <_ZNKSt5ctypeIcE13_M_widen_initEv@plt>
    14a4:	48 8b 03             	mov    (%rbx),%rax
    14a7:	be 0a 00 00 00       	mov    $0xa,%esi
    14ac:	48 89 df             	mov    %rbx,%rdi
    14af:	ff 50 30             	call   *0x30(%rax)
    14b2:	0f be f0             	movsbl %al,%esi
    14b5:	eb c0                	jmp    1477 <main+0x337>
    14b7:	e8 54 fc ff ff       	call   1110 <_ZSt16__throw_bad_castv@plt>
    14bc:	0f 1f 40 00          	nopl   0x0(%rax)

00000000000014c0 <_GLOBAL__sub_I_a>:
    14c0:	f3 0f 1e fa          	endbr64 
    14c4:	53                   	push   %rbx
    14c5:	48 8d 1d f4 35 00 00 	lea    0x35f4(%rip),%rbx        # 4ac0 <_ZStL8__ioinit>
    14cc:	48 89 df             	mov    %rbx,%rdi
    14cf:	e8 4c fc ff ff       	call   1120 <_ZNSt8ios_base4InitC1Ev@plt>
    14d4:	48 8b 3d 1d 2b 00 00 	mov    0x2b1d(%rip),%rdi        # 3ff8 <_ZNSt8ios_base4InitD1Ev@GLIBCXX_3.4>
    14db:	48 89 de             	mov    %rbx,%rsi
    14de:	48 8d 15 23 2b 00 00 	lea    0x2b23(%rip),%rdx        # 4008 <__dso_handle>
    14e5:	5b                   	pop    %rbx
    14e6:	e9 f5 fb ff ff       	jmp    10e0 <__cxa_atexit@plt>
...
00000000000014f0 <_start>:
    ...
    1508:	48 8d 3d 31 fc ff ff 	lea    -0x3cf(%rip),%rdi        # 1140 <main>
...
0000000000001590 <__do_global_dtors_aux>:
    ...
    1594:	80 3d b5 2b 00 00 00 	cmpb   $0x0,0x2bb5(%rip)        # 4150 <completed.0>
    159b:	75 2b                	jne    15c8 <__do_global_dtors_aux+0x38>
    159d:	55                   	push   %rbp
    159e:	48 83 3d 2a 2a 00 00 	cmpq   $0x0,0x2a2a(%rip)        # 3fd0 <__cxa_finalize@GLIBC_2.2.5>
    15a5:	00 
    ...
    15b2:	e8 f9 fa ff ff       	call   10b0 <__cxa_finalize@plt>
    15b7:	e8 64 ff ff ff       	call   1520 <deregister_tm_clones>
    15bc:	c6 05 8d 2b 00 00 01 	movb   $0x1,0x2b8d(%rip)        # 4150 <completed.0>
    15c3:	5d                   	pop    %rbp
    15c4:	c3                   	ret    
