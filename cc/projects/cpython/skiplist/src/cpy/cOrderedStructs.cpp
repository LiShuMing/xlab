 ...
 */
static PyObject *
toss_coin(PyObject */* mod */, PyObject*) {
...
static PyObject *
long_min_value(PyObject */* mod */, PyObject*) {
    return PyLong_FromLongLong(LLONG_MIN);
}

static PyObject *
long_max_value(PyObject */* mod */, PyObject*) {
...
static PyMethodDef orderedstructsmodule_methods[] = {
        ...
        {"min_long",  (PyCFunction) long_min_value, METH_NOARGS, "Minimum value I can handle for an integer."},
        {"max_long",  (PyCFunction) long_max_value, METH_NOARGS, "Maximum value I can handle for an integer."},
