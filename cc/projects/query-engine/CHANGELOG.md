...
- Project-level DESIGN.md and staged TODO/TASKS roadmap
- This CHANGELOG file
...
- Core components:
  - `FlatVector<T>` - Columnar vector representation
  - `HashTable` - Open-addressing hash table for aggregation
...
- Query operators:
  ...
  - `HashJoinOp` - Prototype single-key inner hash join
  - `SortOp` / `TopNOp` - Prototype in-memory ordering
