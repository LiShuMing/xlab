...
// RESULT 26.1.26 15:30:00
// Linux malloc/RSS demo
// Page size: 4096 bytes
// Allocator: glibc (malloc_usable_size + malloc_trim available)

// === 1) Allocator rounding / usable size (metadata + alignment effects) ===
// malloc(     1) -> usable=    24 (delta=   +23)
// malloc(     7) -> usable=    24 (delta=   +17)
// malloc(     8) -> usable=    24 (delta=   +16)
// malloc(    15) -> usable=    24 (delta=    +9)
// malloc(    16) -> usable=    24 (delta=    +8)
// malloc(    17) -> usable=    24 (delta=    +7)
// malloc(    31) -> usable=    40 (delta=    +9)
// malloc(    32) -> usable=    40 (delta=    +8)
// malloc(    33) -> usable=    40 (delta=    +7)
// malloc(   100) -> usable=   104 (delta=    +4)
// malloc(  1000) -> usable=  1000 (delta=    +0)
// malloc(100000) -> usable=100008 (delta=    +8)

// === 2) Many "small" allocations (likely heap/brk): malloc vs touch vs free ===
// Before allocating many blocks       RSS: 972 KB
// After malloc() many blocks (no touch) RSS: 5524 KB
// After touching pages (force RSS up) RSS: 67144 KB
// After free() many blocks (heap may keep RSS) RSS: 1768 KB
// malloc_trim(0) returned: 1
// After malloc_trim(0) (best-effort RSS drop) RSS: 1640 KB

// === 3) One large allocation (often mmap): malloc vs touch vs free ===
// Before malloc() one big block       RSS: 1640 KB
// After malloc() big block (no touch) RSS: 1640 KB
// After touching big block (RSS should jump) RSS: 263660 KB
// After free() big block (often drops quickly if mmap-backed) RSS: 1640 KB
